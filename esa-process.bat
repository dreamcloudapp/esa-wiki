...
call ./esa.bat --count-links-and-terms %2\preprocessed.xml.bz2 %2\titles.xml.bz2 %2\annotated.xml.bz2 --min-in-links 15 --min-out-links 15 --min-terms 100 --id-titles %2\id-titles.txt
